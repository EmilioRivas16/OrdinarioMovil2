...
class JugosViewController: UIViewController {
    
    @IBOutlet weak var mensaje: UILabel!
    var categorias: Array<Jugo> = []

    @IBOutlet weak var miTabla: UITableView!
    func loadCategories() {
        let request = AF.request("https://62858a2ff0e8f0bb7c057f14.mockapi.io/jugos")
        request.responseDecodable(of: Array<Jugo>.self) {response in
    ...
    func changeScrollView(data: Array<Jugo>) {
...
extension JugosViewController:UITableViewDataSource{
...
extension JugosViewController:UITableViewDelegate {
